    ...
    function addCarro() {
        ...
        $.ajax({
            ...
            success:function(r){
                if (r==1) {
                    alertify.alert().set({'startMaximized':false, 'message':'<center><b><font size="6" color="red"> Producto agregado</font></b><br><a href="tienda.php" type="button" class="btn btn-outline-primary">Seguir comprando</a><a href="carrito.php" type="button" class="btn btn-outline-success">Ver Carrito</a> </center>',
